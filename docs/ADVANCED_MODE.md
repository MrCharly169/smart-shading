...
The object calculator supports roller shutters/shades, screens, symmetrically closing curtains, binary covers, and vertical slats. Vertical-slat results are approximate. Exterior Venetian blinds with horizontal slats and awnings are not offered by this calculator.
...
The Card and diagnostics retain the ordinary target, calculated zone target, final target, geometry status, and failure reason. Invalid geometry or missing required source data holds movement rather than issuing a guessed target.
