...
> **Stable-Kanal:** Die aktuelle Release-Linie auf `main` enthält stabile Releases. Aktiviere Vorabversionen in HACS nur, wenn du Beta-Builds von `develop` bewusst testen möchtest.
