...
class FlowContractTests(unittest.TestCase):
    ...
    def test_legacy_migration_freezes_the_pre_v14_effective_mode(self):
        cases = (
            ({"advanced_mode": True}, {}, True),
            ({"advanced_mode": False}, {}, False),
            ({"advanced_mode": True}, {"rooms": []}, True),
            ({"advanced_mode": False}, {"rooms": []}, False),
            ({"advanced_mode": False}, {"advanced_mode": True}, True),
            ({"advanced_mode": True}, {"advanced_mode": False}, False),
            ({}, {"advanced_mode": True}, True),
            ({}, {"advanced_mode": False}, False),
            ({}, {}, False),
            ({}, None, False),
        ...
        for data, options, expected in cases:
            with self.subTest(data=data, options=options):
                self.assertIs(
                    contract.legacy_effective_advanced_mode(data, options),
                    expected,
                )
